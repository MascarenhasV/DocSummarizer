...
function buildTrigramTable(){
	var content = NEW_LINE+START_H3+"The 10 most common trigrams are: "+END_H3+NEW_LINE;
	content += START_TABLE;
...
function buildEditDistanceTableForTrigrams(){
	...
	var content = NEW_LINE+START_H3+"The most common trigrams is: "+mostCommonTrigram+END_H3;
	content += START_TABLE;
